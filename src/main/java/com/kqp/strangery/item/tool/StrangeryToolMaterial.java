...
public class StrangeryToolMaterial implements ToolMaterial {
  ...
  public static final ToolMaterial BEBSOFYR = tool(3, 3122, 7.75F, 2.75F, 10);
  ...
  public static StrangeryToolMaterial tool(
    int miningLevel,
    int durability,
    float miningSpeed,
    float attackDamage,
    ...
    return new StrangeryToolMaterial(
      miningLevel,
      durability,
      miningSpeed,
      attackDamage,
