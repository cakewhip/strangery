...
public class StrangeMonumentFeature extends StructureFeature<DefaultFeatureConfig> {
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        public Start(StructureFeature<DefaultFeatureConfig> structureFeature, int chunkX, int chunkZ,
                     BlockBox blockBox, int references, long seed) {
        ...
        public void init(DynamicRegistryManager dynamicRegistryManager,
            ...
            this.children.add(new StrangeMonumentPiece(
                structureManager,
                new BlockPos(x, y, z)
            ));
