...
public class HealthStatusEffect extends CustomStatusEffect {
    ...
    public HealthStatusEffect(StatusEffectType type, int color, DamageSource damageSource, int damageAmount, int amplifyAmount, int tick) {
        super(type, color);
    ...
    public HealthStatusEffect(StatusEffectType type, int color, int healAmount, int amplifyAmount, int tick) {
