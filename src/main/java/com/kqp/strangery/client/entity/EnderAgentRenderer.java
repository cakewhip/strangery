...
public class EnderAgentRenderer<T extends MobEntity, M extends BipedEntityModel<T>>
    ...
    private static final Identifier TEXTURE = Strangery.id(
        "textures/entity/ender_agent.png"
    );
    ...
    class CustomHeldItemFeatureRenderer<T extends LivingEntity, M extends EntityModel<T> & ModelWithArms>
        ...
        public CustomHeldItemFeatureRenderer(
            FeatureRendererContext featureRendererContext
        ) {
        ...
        public void render(
            ...
            if (!itemStack.isEmpty() || !itemStack2.isEmpty()) {
                ...
                ((HeldItemFeatureRendererAccessor) this).callRenderItem(
                        livingEntity,
                        itemStack2,
